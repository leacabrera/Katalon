...
WebUI.click(findTestObject('Compras/PedidoCompra/PedidoCompra - EM/input_PCConfirmar'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Compras/PedidoCompra/PedidoCompra - EM/check_PCEstado_EnProcesoAutorizacion'), 'En proceso de autorización')
