...
WebUI.click(findTestObject('Compras/PedidoCompra/PedidoCompra - EM/img_PC_Eliminar'))

WebUI.click(findTestObject('Compras/PedidoCompra/PedidoCompra - EM/input_PC_ConfirmarEliminarPC'))

WebUI.verifyTextPresent('Pedidos de compra', false)
